 ...
 */
  ...
  //  m_chooser.setDefaultOption("Shoot and Drive", new Auto_Shoot_and_Drive(m_shooter, m_tower, m_driveTrain));
    ...
    m_chooser.addOption("Shoot and Drive", new Auto_Shoot_and_Drive(m_shooter, m_tower, m_driveTrain));
    m_chooser.setDefaultOption("Auto Two Ball", new Auto_Two_Ball(m_shooter, m_tower, m_driveTrain, m_intake));    
...
joystickRight_ShooterHi.whileHeld(new ShooterRun(.84, m_shooter) ,true);
